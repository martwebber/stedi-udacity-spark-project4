...
ChangeSchema_node1703699245968 = ApplyMapping.apply(
    ...
    transformation_ctx="ChangeSchema_node1703699245968",
)

# Script generated for node Customer Curated
CustomerCurated_node1703700056766 = glueContext.write_dynamic_frame.from_options(
    frame=ChangeSchema_node1703699245968,
    connection_type="s3",
    format="json",
    connection_options={
    ...
    transformation_ctx="CustomerCurated_node1703700056766",
)
